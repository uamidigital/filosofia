...
Click the **Filter** button to expand a set of search filters. Editors can quickly locate all submissions with overdue reviews and those in a specific stage of the workflow. Managing editors can locate submissions assigned to a specific editor.
