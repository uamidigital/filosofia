...
class DefaultThemePlugin extends ThemePlugin {
	...
	public function init() {
		...
		$this->addStyle('mapa', 'styles/mapa.css');
		...
		$this->addStyle(
			'leaflet',
			$request->getBaseUrl() . '/lib/pkp/styles/leaflet/leaflet.css',
			array('baseUrl' => '')
		);

		$this->addStyle(
			'mapa',
			$request->getBaseUrl() . '/lib/pkp/styles/leaflet/mapa.css',
			array('baseUrl' => '')
		);

		$this->addStyle(
			'header',
			$request->getBaseUrl() . '/lib/pkp/styles/header/estilos.css',
			array('baseUrl' => '')
		);
		...
		$this->addScript(
			'leaflet',
			$request->getBaseUrl() . '/lib/pkp/js/leaflet/leaflet.js',
			array('baseUrl' => '')
		);
		$this->addScript(
			'mapa',
			$request->getBaseUrl() . '/lib/pkp/js/leaflet/mapa.js',
			array('baseUrl' => '')
		);
