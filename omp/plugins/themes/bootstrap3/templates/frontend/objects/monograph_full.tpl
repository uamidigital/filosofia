...
* elements (eg, <h3>) or any element required.
    ...
    *}
    ...
    <!--Aquí empieza el código para la descripción completa de la obra -->
    <div class="obj_monograph_full">
        <div class="container">
                ...
                <div class="item authors">
                    ...
                    <div class="main_entry">
                        ...
                        <div class="item authors ">
                            ...
                            {if $authors|@count < 5} {foreach from=$authors item=author} <div class="sub_item">
                                <div class="label subtitulo">
                                ...
                                <div class="value afiliacion">
                                    {$author->getLocalizedAffiliation()|escape}
                                </div>
                                {/if}
                                {if $author->getOrcid()}
                                <span class="orcid orkid" syle="display:none;">
                                    <a href="{$author->getOrcid()|escape}" target="_blank" syle="display:none;">
                        ...
                        {if $author->getLocalizedAffiliation()}
                        {if $identifyAsEditors}
                        {capture assign="authorName"}<span class="label">{translate key="submission.editorName"
                            editorName=$author->getFullName()|escape}</span>{/capture}
                        {else}
                        {capture assign="authorName"}<span
                            class="label">{$author->getFullName()|escape}</span>{/capture}
                        {/if}
                        {capture assign="authorAffiliation"}<span
                            class="value">{$author->getLocalizedAffiliation()|escape}</span>{/capture}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h3 class="my-3 label subtitulo">Sinópsis</h3>
                            <hr />
                            {* Abstract *}
                            <div class="resumen">
                    ...
                    <div class="row">
                        <section id="tabs">
                            <div class="container">
                                <hr>
                                <h3 class="my-4 detalles">Detalles</h3>
                                <hr>
                                <div class="row">
                                    <div class="col-xs-12 ">
                                        <nav id="det">
                                            <div class="nav nav-tabs active" id=" nav-tab" role="tablist">
                                                <a class="nav-item nav-link" id="nav-home-tab" data-toggle="tab"
                                                    href="#Capitulos" role="tab" aria-controls="nav-home"
                                                    aria-selected="true">Capítulos</a>
                                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab"
                                                    href="#pClave" role="tab" aria-controls="nav-profile"
                                                    aria-selected="false">&nbsp;Palabras clave</a>
                                                <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab"
                                                    href="#cDescarga" role="tab" aria-controls="nav-contact"
                                                    aria-selected="false">&nbsp;Comprar/Descargar</a>
                                                <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab"
                                                    href="#refe" role="tab" aria-controls="nav-about"
                                                    aria-selected="false">&nbsp;Referencias</a>
                                                <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab"
                                                    href="#pubf" role="tab" aria-controls="nav-about"
                                                    aria-selected="false">&nbsp;Fecha de publicación</a>
                                                <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab"
                                                    href="#ser" role="tab" aria-controls="nav-about"
                                                    aria-selected="false">&nbsp;Series</a>
                                                <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab"
                                                    href="#cate" role="tab" aria-controls="nav-about"
                                                    aria-selected="false">&nbsp;Categorías</a>
                                                <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab"
                                                    href="#der" role="tab" aria-controls="nav-about"
                                                    aria-selected="false">&nbsp;Declaración de derechos</a>
                                            </div>
                                        </nav>
                                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                            <div class="tab-pane fade" id="Capitulos" role="tabpanel"
                                                ...
                                                <div class="item chapters">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            {assign var=chapterAuthors
                                                            value=$chapter->getAuthorNamesAsString()}
                                                            ...
                                                            {/if}
                                                            {assign var=pubId
                                                            value=$chapter->getStoredPubId($pubIdPlugin->getPubIdType())}
                                                            {if $pubId}
                                                            {assign var="doiUrl"
                                                            value=$pubIdPlugin->getResolvingURL($currentPress->getId(),
                                                            $pubId)|escape}
                                                            <div class="doi">{translate
                                                                key="plugins.pubIds.doi.readerDisplayName"} <a
                                                                    href="{$doiUrl}">{$doiUrl}</a></div>
                                                            {/if}
                                                            {/foreach}

                                                            {* Display any files that are assigned to this chapter *}
                                                            {pluck_files assign="chapterFiles" files=$availableFiles
                                                            by="chapter" value=$chapterId}
                                                            {if $chapterFiles|@count}
                                                            <div class="files">

                                                                {* Display chapter files sorted by publication format so
                                                                that they are ordered
                                                                consistently across all chapters. *}
                                                                {foreach from=$publicationFormats item=format}
                                                                {pluck_files assign="pubFormatFiles" files=$chapterFiles
                                                                by="publicationFormat"
                                                                value=$format->getId()}

                                                                {foreach from=$pubFormatFiles item=file}

                                                                {* Use the publication format name in the download link
                                                                unless a pub format has multiple
                                                                files *}
                                                                ...
                                                                {include file="frontend/components/descargaBT.tpl"
                                                                downloadFile=$file monograph=$monograph
                                                                publicationFormat=$format currency=$currency
                                                ...
                                                <div class="item author_bios">
                                                    ...
                                                    <div class="sub_item">
                                                        <div class="label">
                                                            {if $author->getLocalizedAffiliation()}
                                                            {capture
                                                            assign="authorName"}{$author->getFullName()|escape}{/capture}
                                                            {capture assign="authorAffiliation"}<span
                                                                class="affiliation">{$author->getLocalizedAffiliation()|escape}</span>{/capture}
                                                            {translate key="submission.authorWithAffiliation"
                                                            name=$authorName
                                                            affiliation=$authorAffiliation}
                                                            {else}
                                                            {$author->getFullName()|escape}
                                            ...
                                            <div class="tab-pane fade" id="pClave" role="tabpanel"
                                                aria-labelledby="nav-profile-tab">
                                                {* Keywords *}
                                                {if !empty($publication->getLocalizedData('keywords'))}
                                                <div class="item keywords">
                                                    <h6 class="value resumen">
                                                        {foreach name="keywords"
                                                        from=$publication->getLocalizedData('keywords') item=keyword}
                                            ...
                                            <div class="tab-pane fade" id="cDescarga" role="tabpanel"
                                                aria-labelledby="nav-contact-tab">
                                                <div class="entry_details">

                                                    {* Any non-chapter files and remote resources *}
                                                    {pluck_files assign=nonChapterFiles files=$availableFiles
                                                    by="chapter" value=0}
                                                    ...
                                                    <div class="item files">
                                                        ...
                                                        {* Only one resource allowed per format, so mimic
                                                        single-file-download *}
                                                        <div
                                                            class="pub_format_{$publicationFormatId|escape} pub_format_remote">
                                                            <a href="{$format->getRemoteURL()|escape}" target="_blank"
                                                        ...
                                                        *}
                                                        {pluck_files assign=pubFormatFiles files=$nonChapterFiles
                                                        by="publicationFormat"
                                                        value=$format->getId()}
                                                        ...
                                                        {if $pubFormatFiles|@count == 1}
                                                        <div
                                                            class="pub_format_{$publicationFormatId|escape} pub_format_single">
                                                            {foreach from=$pubFormatFiles item=file}
                                                            {include file="frontend/components/downloadLink.tpl"
                                                            downloadFile=$file monograph=$monograph
                                                            publication=$publication publicationFormat=$format
                                                            currency=$currency}
                                                            {/foreach}
                                                        </div>
                                                            ...
                                                            <span class="value">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        <span class="link">
                                                                            {include
                                                                            file="frontend/components/downloadLink.tpl"
                                                                            downloadFile=$file
                                                                            monograph=$monograph
                                                                            publication=$publication
                                                                            publicationFormat=$format
                                                                            currency=$currency useFilename=true}
                                                                        </span>
                                                                    </li>
                                                                    {/foreach}
                                                                </ul>
                                                    ...
                                                    <div class="item series">
                                                        <div class="sub_item">
                                                            ...
                                                            <div class="value">
                                                                <a href="{url page=" catalog" op="series"
                                                                    path=$series->getPath()}">
                                                        ...
                                                        <div class="sub_item">
                                                            <h3 class="label">{translate
                                                                key="catalog.manage.series.onlineIssn"}</h3>
                                                        ...
                                                        <div class="sub_item">
                                                            <h3 class="label">{translate
                                                                key="catalog.manage.series.printIssn"}</h3>
                                                    ...
                                                    {assign var=identificationCodes
                                                    value=$publicationFormat->getIdentificationCodes()}
                                                    {assign var=identificationCodes
                                                    value=$identificationCodes->toArray()}
                                                    {assign var=publicationDates
                                                    value=$publicationFormat->getPublicationDates()}
                                                    ...
                                                    {* Skip if we don't have any information to print about this pub
                                                    format *}
                                                    ...
                                                    <div class="item publication_format">
                                                        ...
                                                        {* Only add the format-specific heading if multiple publication
                                                        formats exist *}
                                                        {if count($publicationFormats) > 1}
                                                        <h2 class="pkp_screen_reader">
                                                            {assign var=publicationFormatName
                                                            value=$publicationFormat->getLocalizedName()}
                                                            {translate key="monograph.publicationFormatDetails"
                                                            format=$publicationFormatName|escape}
                                                        </h2>
                                                        ...
                                                        {foreach from=$pubIdPlugins item=pubIdPlugin}
                                                        {assign var=pubIdType value=$pubIdPlugin->getPubIdType()}
                                                        {assign var=storedPubId
                                                        value=$publicationFormat->getStoredPubId($pubIdType)}
                                                        {if $storedPubId != ''}
                                                        <div
                                                            class="sub_item pubid {$publicationFormat->getId()|escape}">
                                                            <h2 class="label">
                                                                {$pubIdType}
                                                            </h2>
                                                            <div class="value">
                                                        ...
                                                        <div class="sub_item dimensions">
                                                            <h2 class="label">
                                                                {translate
                                                                key="monograph.publicationFormat.productDimensions"}
                                                            </h2>
                                                            <div class="value">
                                            ...
                                            <div class="tab-pane fade" id="refe" role="tabpanel"
                                            ...
                                            <div class="tab-pane fade" id="pubf" role="tabpanel"
                                                aria-labelledby="nav-about-tab">
                                                {* Publication Date *}
                                                ...
                                                <div class="item date_published">
                                                    <div class="sub_item">
                                                        <h2 class="label">
                                                            ...
                                                            >
                                                            $smarty.now|date_format:$dateFormatShort}
                                                        ...
                                                        <div class="value">
                                                            ...
                                                            <span>{translate key="submission.updatedOn"
                                                                ...
                                                                dateUpdated=$publication->getData('datePublished')|date_format:$dateFormatLong}</span>
                                                            {/if}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="sub_item versions">
                                                        ...
                                                        <ul class="value">
                                                            {foreach
                                                            from=array_reverse($monograph->getPublishedPublications())
                                                            item=iPublication}
                                                            {capture assign="name"}{translate
                                                            ...
                                                            <li>
                                                                ...
                                                                {$name}
                                                                {elseif $iPublication->getId() ===
                                                                $currentPublication->getId()}
                                                                <a href="{url page=" catalog" op="book"
                                                                    path=$monograph->getBestId()}">{$name}</a>
                                                                {else}
                                                                <a href="{url page=" catalog" op="book"
                                                                    path=$monograph->getBestId()|to_array:"version":$iPublication->getId()}">{$name}</a>
                                                                {/if}
                                                            </li>
                                                            {/foreach}
                                                        </ul>
                                            ...
                                            <div class="tab-pane fade" id="der" role="tabpanel"
                                                aria-labelledby="nav-about-tab">
                                                {* Copyright statement *}
            ...
            <!--Aquí termina el código para la descripción completa de la obra -->
            <hr />
        </div>